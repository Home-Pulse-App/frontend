import type { AuthState, CreateDeviceData, CreateHomeData, CreateRoomData, CreateUserData, CreateUserResponse, Device, DeviceDataResponse, DeviceReading, DeviceStatsResponse, Home, LoginCredentials, LoginResponse, PaginationParams, PostDeviceDataPayload, Room, SensorType, UpdateUserData, User } from '@/types/api-services';
