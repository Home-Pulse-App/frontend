import type { AuthState, CreateDeviceData, CreateHomeData, CreateRoomData, CreateUserData, Device, DeviceDataResponse, DeviceReading, DeviceStatsResponse, Home, LoginCredentials, LoginResponse, PaginationParams, PostDeviceDataPayload, Room, SensorType, UpdateUserData, User } from '@/types/api-services';
